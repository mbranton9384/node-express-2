...
class User {
  ...
  static async authenticate(username, password) {
    try {
      ...
      throw new ExpressError('Error authenticating user', 500);
    }
  }
  ...
  static async getAll() {
    try {
      ...
      throw new ExpressError('Error retrieving users', 500);
    }
  }
  ...
  static async get(username) {
    try {
      ...
      throw new ExpressError('Error retrieving user', 500);
    }
  }
  ...
  static async delete(username) {
    try {
      ...
      throw new ExpressError('Error deleting user', 500);
    }
  }
}
