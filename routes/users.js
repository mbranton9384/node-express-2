...
const { authUser, requireLogin, requireAdmin, requireAdminOrSelf } = require('../middleware/auth');
...
router.patch('/:username', authUser, requireLogin, requireAdminOrSelf, async function(
  req,
  res,
  next
) {
